...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-files-o"></i> <span>Categorias</span> <i
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015 <a href="#" target="_blank">Luiz Henrique</a>.</strong>
...
<script src="{{URL::asset('d-mill-en.js')}}" type="text/javascript"></script>
<!-- jQuery Knob Chart -->
...
<script src="{{URL::asset('dist/js/pages/dashboard.js')}}" type="text/javascript"></script>
